...
const translations = {
  vi: {
    ...
    'products.addProductTracking': 'Thêm sản phẩm theo dõi',
    'products.productName': 'Tên sản phẩm',
    'products.keywords': 'Từ khóa',
    'products.productNamePlaceholder': 'Nhập tên sản phẩm',
    'products.categoryPlaceholder': 'Chọn danh mục',
    'products.pricePlaceholder': 'Nhập giá trung bình',
    'products.keywordsPlaceholder': 'Nhập từ khóa, phân cách bằng dấu phẩy',
    'products.statusPlaceholder': 'Chọn trạng thái',
    'products.tracking': 'Theo dõi',
    'products.notTracking': 'Không theo dõi',
    ...
    'leads.addLeadTitle': 'Thêm khách hàng tiềm năng',
    'leads.addLeadDescription': 'Nhập thông tin khách hàng tiềm năng mới.',
    'leads.fullName': 'Họ và tên',
    'leads.phoneNumber': 'Số điện thoại',
    'leads.emailAddress': 'Địa chỉ email',
    'leads.location': 'Địa điểm',
    'leads.productInterest': 'Sản phẩm quan tâm',
    'leads.type': 'Loại',
    'leads.buying': 'Mua',
    'leads.selling': 'Bán',
    'leads.budget': 'Ngân sách',
    'leads.highPriority': 'Cao',
    'leads.mediumPriority': 'Trung bình',
    'leads.lowPriority': 'Thấp',
    'leads.contactDate': 'Ngày liên hệ',
    'leads.notes': 'Ghi chú',
    'leads.selectDate': 'Chọn ngày',
    'leads.namePlaceholder': 'Nhập họ và tên',
    'leads.phonePlaceholder': 'Nhập số điện thoại',
    'leads.emailPlaceholder': 'Nhập email',
    'leads.locationPlaceholder': 'Nhập địa điểm',
    'leads.interestPlaceholder': 'Nhập sản phẩm quan tâm',
    'leads.budgetPlaceholder': 'Nhập ngân sách',
    'leads.notesPlaceholder': 'Nhập ghi chú',
    'leads.selectType': 'Chọn loại',
    'leads.selectPriority': 'Chọn mức ưu tiên',
    'leads.selectSource': 'Chọn nguồn',
    'leads.facebook': 'Facebook',
    'leads.instagram': 'Instagram',
    'leads.twitter': 'Twitter',
  ...
  en: {
    ...
    'products.addProductTracking': 'Add Product Tracking',
    ...
    'products.pricePlaceholder': 'Enter average price',
    'products.keywordsPlaceholder': 'Enter keywords, separated by commas',
    'products.statusPlaceholder': 'Select status',
    'products.tracking': 'Tracking',
    'products.notTracking': 'Not Tracking',
    ...
    'leads.closed': 'Closed',
    'leads.addLeadTitle': 'Add Potential Customer',
    'leads.addLeadDescription': 'Enter information for a new potential customer.',
    'leads.fullName': 'Full Name',
    'leads.phoneNumber': 'Phone Number',
    'leads.emailAddress': 'Email Address',
    'leads.location': 'Location',
    'leads.productInterest': 'Product Interest',
    'leads.type': 'Type',
    'leads.buying': 'Buying',
    'leads.selling': 'Selling',
    'leads.budget': 'Budget',
    'leads.highPriority': 'High',
    'leads.mediumPriority': 'Medium',
    'leads.lowPriority': 'Low',
    'leads.contactDate': 'Contact Date',
    'leads.notes': 'Notes',
    'leads.selectDate': 'Select Date',
    'leads.namePlaceholder': 'Enter full name',
    'leads.phonePlaceholder': 'Enter phone number',
    'leads.emailPlaceholder': 'Enter email address',
    'leads.locationPlaceholder': 'Enter location',
    'leads.interestPlaceholder': 'Enter product interest',
    'leads.budgetPlaceholder': 'Enter budget',
    'leads.notesPlaceholder': 'Enter notes',
    'leads.selectType': 'Select Type',
